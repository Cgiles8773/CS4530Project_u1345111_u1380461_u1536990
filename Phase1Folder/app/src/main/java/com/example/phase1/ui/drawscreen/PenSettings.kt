                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            //Square
                            Button(
                                onClick = { viewModel.brushShape = (BrushShape.Square) },
                            ...
                            //Circle
                            Button(
                                onClick = { viewModel.brushShape = (BrushShape.Circle) },
                                modifier = Modifier.size(64.dp)
                            ) {
                            ...
                            //Triangle
                            Button(
                                onClick = { viewModel.brushShape = (BrushShape.Triangle) },
                                modifier = Modifier.size(64.dp)
                            ) {
                                Box(
                                    modifier = Modifier
    ...
    when {
        orientation == Configuration.ORIENTATION_LANDSCAPE -> {
            Dialog(onDismissRequest = onDismiss, properties = DialogProperties(usePlatformDefaultWidth = false))
            {
                Card(
                    modifier = Modifier
                        .fillMaxWidth(0.7f)   // control width fraction here
                        .wrapContentHeight()
                        .padding(16.dp),
                    shape = RoundedCornerShape(16.dp),
                    elevation = CardDefaults.cardElevation(defaultElevation = 6.dp)
